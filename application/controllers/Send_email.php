    ...
    public function index()
    {
      // Konfigurasi email
        $config = [
            ...
            'smtp_user' => 'selmiselmimi@gmail.com',  // Email gmail
            'smtp_pass'   => 'Selmi2232..',  // Password gmail
            'smtp_crypto' => 'ssl',
            'smtp_port'   => 465,
            'crlf'    => "\r\n",
            'newline' => "\r\n"
        ...
        $this->email->from('selmiselmimi@gmail.com', 'skripsiiot.com');

        // Email penerima
        $this->email->to('selmipoters12@gmail.com'); // Ganti dengan email tujuan
